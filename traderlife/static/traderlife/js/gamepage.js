...
$(document).ready(function () {
        ...
        function ui_add_good_to_order(good) {
            ...
            order_goodprice = $("<td class='order_item_sum'>").text("$" + kFormatter(good.count * good.price));
        ...
        function add_good_count(order, goodname, count, price, good_2b_add_id) {
            ...
            $(".order_tr:eq(" + good_2b_add_id + ")").find(".order_item_sum").text("$" + kFormatter(good.count * good.price));
        }
